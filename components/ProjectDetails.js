  ...
  return (
    <View style={styles.container}>
      <ScrollView showsVerticalScrollIndicator={false} keyboardShouldPersistTaps='handled'>
        ...
        <View style={styles.label}>
            <TouchableOpacity style={styles.editNotesBtn} onPress={handleEditNotes} placeholder='Make sure to click the edit icon again to save'><Image style={styles.deleteImg}source={require("../assets/edit.png")}/></TouchableOpacity>
            <Text style={styles.title}>Notes</Text>
        </View>
        {showEditNotes ? (<TextInput style={styles.notesInput} multiline={true} value={notes} onChangeText={handleNotesChange}></TextInput>) : (<Text style={styles.notesTxt}>{project.notes}</Text>)}
